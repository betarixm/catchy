...
urlpatterns = [
    ...
    path("flows/new/", views.flow_create, name="flow_create"),
    path("flows/<slug:slug>/", views.flow_detail, name="flow_detail"),
    path("flows/<slug:slug>/edit/", views.flow_update, name="flow_update"),
